...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Reza Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' RedArmyGang')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To Reza tool')
	    psb('Congratulations Reza Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Reza✓')
	    psb('🔓Password ☆ rezafuckmiahkhalifa✓')
	    psb('Follow my facebook account https://www.facebook.com/GOD.OF.VIRTUU4L✓')
